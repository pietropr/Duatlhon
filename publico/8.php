...
<body>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: -40px;">
    <tr>
      <td width="400"align="left"><img src="../imagens/rsgt.png" width="183" height="125"></td>
      			<td width="376" align="center"><p><img src="../imagens/logo fatec.png" alt="" width="185" height="105"></td>
	  <td width="376" align="right"><img src="../imagens/esqueda.png" width="295" height="115"></td>
    </tr>
  </table>
<!-- Logo Corrida -->
...
<?php 
	$corrida = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 210");  
...
<?php 
	$corrida2 = mysql_query("SELECT * FROM corrida ORDER BY id LIMIT 15 OFFSET 225");  
	$i=1;
