...
<?php 
	$corrida = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 60");  
...
<?php 
	$corrida2 = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 75");  
	$i= 0;
...
<?
	...
	if($i>=15){
		echo "<meta HTTP-EQUIV='refresh' CONTENT='3;URL=4.php'>";
	}else{
