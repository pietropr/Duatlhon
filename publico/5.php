  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: -40px;">
    <tr>
      <td width="400"align="left"><img src="../imagens/rsgt.png" width="155" height="125"></td>
      			<td width="376" align="center"><p><img src="../imagens/logo fatec.png" alt="" width="189" height="105"></td>
      			<td width="376" align="right"><img src="../imagens/esqueda.png" width="289" height="118"></td>
    </tr>
  </table>
<!-- Logo Corrida -->
...
<?php 
	$corrida = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 120");  
...
<?php 
	$corrida2 = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 135"); 
	$i=0; 
...
<?php
  ...
  ?>
	...
	if($i>=15){	
		echo "<meta HTTP-EQUIV='refresh' CONTENT='3;URL=6.php'>";
	}else{
