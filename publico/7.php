...
<?php 
	$corrida = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 180");  
...
<?php 
	$corrida2 = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 195");  
	$i=0;
...
<?
	...
	if($i>=15){
		echo "<meta HTTP-EQUIV='refresh' CONTENT='3;URL=8.php'>";
	}else{
