...
<?php 
	$corrida = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 150");  
...
<?php 
	$corrida2 = mysql_query("SELECT * FROM corrida ORDER BY tran_ini_co DESC LIMIT 15 OFFSET 165");  
	$i=0;
...
<?
	...
	if($i>=15){
		echo "<meta HTTP-EQUIV='refresh' CONTENT='3;URL=7.php'>";
	}else{
